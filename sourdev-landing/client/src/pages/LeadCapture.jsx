...
const StepPlan = ({ submitLead, loading }) => (
            ...
            <div className="relative z-10 w-full px-4">
                <AnimatePresence mode="wait">
                    {success ? (
                        ...
                        <>
                            {step === 0 && <StepContainer key="0"><StepIntro setStep={setStep} /></StepContainer>}
                            {step === 1 && <StepContainer key="1"><StepPain handleNext={handleNext} /></StepContainer>}
                            {step === 2 && <StepContainer key="2"><StepData handleNext={handleNext} handleTyping={handleTyping} /></StepContainer>}
                            {step === 3 && <StepContainer key="3"><StepPlan submitLead={submitLead} loading={loading} /></StepContainer>}
                        </>
                    )}
                </AnimatePresence>
            </div>
